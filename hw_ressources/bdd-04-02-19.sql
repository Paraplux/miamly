...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 04 fév. 2019 à 17:26
...
(1, 'theparaplux@gmail.com', '$2y$10$ULX6.139E36ek2QOChnCgO6a9WZcONYu7A22GBqyoz6FvR0T48.2m', 'Paraplux', '../images/avatars/avatar_bd56338d6797374e1b3bedd5eac5250ba1fdc360.jpg', 'Bouchez', 'Marc', '28', 'Couscous', 'Poulet', 'Le royal', '28', '16,3,2,4,6'),
...
--
ALTER TABLE `mly_commentaires`
  MODIFY `c_id` int(51) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
